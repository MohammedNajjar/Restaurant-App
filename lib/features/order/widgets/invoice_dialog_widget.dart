...
import 'package:stackfood_multivendor_restaurant/features/order/widgets/fixed_printer.dart';
...
class InvoiceDialogWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double fontSize = window.physicalSize.width > 1000
...
// Your existing code...
    ...
    return SingleChildScrollView(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
                    ...
                    Row(children: [
                      Expanded(
                          ...
                          child: Text('sl'.tr.toUpperCase(),
                              style:
                                  robotoMedium.copyWith(fontSize: fontSize))),
                      Expanded(
                          flex: 5,
                    ...
                    order!.paymentMethod == 'partial_payment'
                        ? Column(children: [
                            ...
                            PriceWidget(
                                ...
                                value:
                                    _priceDecimal(order!.payments![0].amount!),
                                fontSize: fontSize),
                            const SizedBox(
                                height: Dimensions.paddingSizeExtraSmall),
                            PriceWidget(
                                ...
                                value:
                                    _priceDecimal(order!.payments![1].amount!),
                                fontSize: fontSize),
                            const SizedBox(
                                height: Dimensions.paddingSizeExtraSmall),
                          ])
        ...
        Builder(
          builder: (context) => CustomButtonWidget(
              ...
              onPressed: () async {
                ...
                controllerfsg
                  ...
                  await SunmiPrinter.printImage(value);
                  // Get.back();
